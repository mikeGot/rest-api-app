...
Revision ID: e32195d58ce0
Revises:
Create Date: 2026-01-15 19:52:10.478678
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_organizations_building_id"), "organizations", ["building_id"], unique=False
    )
